...
resource demo_rule 'Microsoft.Security/detectionRules@2026-01-01-preview' existing = {
  displayName: 'demo test'
}

output queryText string = demo_rule.queryCondition.queryText
